...
void terminal_initialize(void) {
    ...
    outb(0x3D4, 0x17); outb(0x3D5, 0xE3);  // video enable, byte mode
    ...
    // Cursor shape - visible
    outb(0x3D4, 0x0A); outb(0x3D5, 0x0E);  // cursor start scan line 14
    outb(0x3D4, 0x0B); outb(0x3D5, 0x0F);  // cursor end scan line 15
